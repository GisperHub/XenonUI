local library = {
	Version = "0.33",
	WorkspaceName = "Xenon Hub Premium Scripts",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
	...
	colors = {
		...
		background = Color3.fromRGB(102, 0, 255),
		outerBorder = Color3.fromRGB(102, 0, 255),
		innerBorder = Color3.fromHex('6600ff'),
		topGradient = Color3.fromRGB(102, 0, 255),
		bottomGradient = Color3.fromRGB(102, 0, 255),
		sectionBackground = Color3.fromRGB(102, 0, 255),
		section = Color3.fromRGB(102, 0, 255),
		otherElementText = Color3.fromRGB(102, 0, 255),
		elementText = Color3.fromRGB(102, 0, 255),
		elementBorder = Color3.fromRGB(102, 0, 255),
		selectedOption = Color3.fromRGB(102, 0, 255),
		unselectedOption = Color3.fromRGB(102, 0, 255),
		hoveredOptionTop = Color3.fromRGB(102, 0, 255),
		unhoveredOptionTop = Color3.fromRGB(102, 0, 255),
		hoveredOptionBottom = Color3.fromRGB(102, 0, 255),
		unhoveredOptionBottom = Color3.fromRGB(102, 0, 255),
		tabText = Color3.fromRGB(102, 0, 255)
	},
	gui_parent = (function()
